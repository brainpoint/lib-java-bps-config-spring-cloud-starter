...
import org.springframework.cloud.stream.binder.bprabbit.RabbitExpressionEvaluatingInterceptor;
import org.springframework.cloud.stream.binder.bprabbit.properties.BpRabbitProperties;
import org.springframework.cloud.stream.binder.bprabbit.properties.BpRabbitProperties.ContainerType;
import org.springframework.cloud.stream.binder.bprabbit.properties.BpRabbitProperties.Retry;
...
import org.springframework.cloud.stream.binder.bprabbit.properties.RabbitExtendedBindingProperties;
 ...
 */
// @checkstyle:off
public class BpRabbitMessageChannelBinder extends
	...
	private final BpRabbitProperties rabbitProperties;
	...
	public BpRabbitMessageChannelBinder(ConnectionFactory connectionFactory,
			BpRabbitProperties rabbitProperties,
	...
	protected MessageProducer createConsumerEndpoint(
		...
		listenerContainer.setMessagePropertiesConverter(
				BpRabbitMessageChannelBinder.inboundMessagePropertiesConverter);
		...
		if (properties.getExtension().isRepublishToDlq()) {
			return new MessageHandler() {
				...
				private final RabbitTemplate template = new RabbitTemplate(
						BpRabbitMessageChannelBinder.this.connectionFactory);
