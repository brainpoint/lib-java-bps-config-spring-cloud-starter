...
package org.springframework.cloud.stream.binder.bprabbit.properties;
...
@ConfigurationProperties(prefix = "spring.cloud.config.bus.rabbitmq")
public class BpRabbitProperties {
	...
	public class Ssl {
		...
		public boolean determineEnabled() {
			if (CollectionUtils.isEmpty(BpRabbitProperties.this.parsedAddresses)) {
				return isEnabled();
			}
			Address address = BpRabbitProperties.this.parsedAddresses.get(0);
